...
\]
where \( \psi \) is light (photon), \( \hbar \) is the reduced Planck's constant, and \( H \) is a Hamiltonian operator representing the lens. The solution to the Schr\"{o}dinger equation gives us the evolution $U$ of the light wave.
\begin{defn}
\begin{eqnarray}
