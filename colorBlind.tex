...
\title{No Hermitian Lens Can Improve Color-Blindness---a Mathematical Proof}
\author{J.L.}
\date{\today}
...
A normal vision system perceives color $\vec{c}= (r,g,b)$, with proper normalization, in the following process, 
\begin{equation}
\vec{c} = V \psi 
\end{equation}
